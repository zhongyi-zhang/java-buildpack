...
**NOTE:**
  ...
  * If using `jdbcUrlForAuditingEnabled` on Azure China Cloud, you need to:
      ...
      1. Follow this [doc](https://www.azure.cn/documentation/articles/aog-web-app-java-import-wosign-certification/) to import a certification to key store file `cacerts`.
