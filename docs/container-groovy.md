...
**NOTE:**
  ...
  * If using `jdbcUrlForAuditingEnabled` on Azure China Cloud, you need to follow this [doc](https://www.azure.cn/documentation/articles/aog-web-app-java-import-wosign-certification/) to import a certification and follow this [doc](https://github.com/cloudfoundry/java-buildpack/blob/master/docs/jre-open_jdk_jre.md#custom-ca-certificates) to custom the key store for your app.
